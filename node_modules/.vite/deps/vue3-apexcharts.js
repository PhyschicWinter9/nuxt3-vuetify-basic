  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var w = function() {
      ...
      return r(t2, [{ key: "setOrientations", value: function(t3) {
        ...
        return this.annoCtx.inversedReversedAxis && (n2 = (s2 - e2.x2) / (r2 / i2.globals.gridWidth)), "category" !== i2.config.xaxis.type && !i2.config.xaxis.convertedCatToNumeric || this.annoCtx.invertAxis || i2.globals.dataFormatXNumeric || (n2 = this.getStringX(e2.x2)), "x1" === t3 ? o2 : n2;
    ...
    var I = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, e2, i2) {
        ...
        var n2 = this.w, l2 = s2, h2 = new b(this.ctx), c2 = new v(this.ctx), d2 = new T(this.ctx), g2 = new M(this.ctx), u2 = new m(this.ctx), p2 = g2.getMarkerConfig({ cssClass: "apexcharts-marker", seriesIndex: l2, dataPointIndex: r2, finishRadius: "bubble" === n2.config.chart.type || n2.globals.comboCharts && n2.config.series[s2] && "bubble" === n2.config.series[s2].type ? a2 : null });
        a2 = p2.pSize;
    ...
    var B = function() {
      ...
      return r(t2, [{ key: "isMultiFormat", value: function() {
        ...
        s2.isRangeBar = "rangeBar" === a2.chart.type && s2.isBarHorizontal, s2.hasGroups = "category" === a2.xaxis.type && void 0 !== a2.xaxis.group && void 0 !== a2.xaxis.group.groups && a2.xaxis.group.groups.length > 0, s2.hasGroups && (s2.groups = a2.xaxis.group.groups);
        for (var n2 = function() {
            ...
            if (n2.length && 0 === e4 && l2.push(n2.join(a2)), t5.data && t5.data.length)
              for (var s3 = 0; s3 < t5.data.length; s3++) {
                ...
                if (r3 || (c2.isFormatXY() ? r3 = i2[e4].data[s3].x : c2.isFormat2DArray() && (r3 = i2[e4].data[s3] ? i2[e4].data[s3][0] : "")), 0 === e4) {
                  n2.push((d3 = r3, "datetime" === o2.config.xaxis.type && String(d3).length >= 10 ? o2.config.chart.toolbar.export.csv.dateFormatter(r3) : x.isNumber(r3) ? r3 : r3.split(a2).join("")));
    ...
    var U = function() {
      ...
      return r(t2, [{ key: "drawGridArea", value: function() {
        ...
        if (!(0 === e2 && l2.globals.skipFirstTimelinelabel || e2 === o2 - 1 && l2.globals.skipLastTimelinelabel && !l2.config.xaxis.labels.formatter || "radar" === l2.config.chart.type)) {
          ...
          var h2 = 0;
          if (l2.globals.hasGroups && (void 0 === l2.config.xaxis.tickAmount || "dataPoints" === l2.config.xaxis.tickAmount) && "between" === l2.config.xaxis.tickPlacement) {
    ...
    var q = function() {
      ...
      return r(t2, [{ key: "niceScale", value: function(t3, e2) {
        ...
        return 0 === t3 && a2.unshift(t3), { result: a2, niceMin: a2[0], niceMax: a2[a2.length - 1] };
    ...
    var Mt = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, e2, i2) {
        ...
        if (o2.config.stroke.show && !this.pointsChart) {
          var b2 = null;
          b2 = "line" === i2 ? l2.fillPath({ seriesNumber: a2, i: s2 }) : o2.globals.stroke.colors[a2];
        ...
        for (var e2 = t3.series, i2 = t3.realIndex, a2 = t3.i, s2 = t3.x, r2 = t3.y, o2 = t3.pX, n2 = t3.pY, l2 = t3.pathsFrom, h2 = t3.linePaths, c2 = t3.areaPaths, d2 = t3.seriesIndex, g2 = t3.lineYPosition, u2 = t3.xArrj, p2 = t3.yArrj, f2 = this.w, b2 = new m(this.ctx), v2 = this.yRatio, y2 = l2.prevY, w2 = l2.linePath, k2 = l2.areaPath, A2 = l2.pathFromLine, S2 = l2.pathFromArea, C2 = x.isNumber(f2.globals.minYArr[i2]) ? f2.globals.minYArr[i2] : f2.globals.minY, L2 = f2.globals.dataPoints > 1 ? f2.globals.dataPoints - 1 : f2.globals.dataPoints, P2 = 0; P2 < L2; P2++) {
          ...
          if (f2.globals.isXNumeric) {
            ...
            void 0 === f2.globals.seriesX[i2][P2 + 1] && (M2 = f2.globals.seriesX[i2][L2 - 1]), s2 = (M2 - f2.globals.minX) / this.xRatio;
          } else
            s2 += this.xDivision;
